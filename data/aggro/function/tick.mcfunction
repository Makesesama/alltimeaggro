...
execute in minecraft:overworld run function aggro:tick_dim
execute in minecraft:the_nether run function aggro:tick_dim
execute in minecraft:the_end run function aggro:tick_dim
